...
//              calendarHeaderHtml+=    "</div>";
      ...
      _renderCalendarBody: function($calendarContainer) { 
        ...
        $calendarContainer.find('.wc-full-height-column').height((options.timeslotHeight * options.timeslotsPerDay) - 265);
        ...
        */
        $calendarContainer.find('.wc-time-header-cell').css({
          height: (options.timeslotHeight * options.timeslotsPerHour) - 13,
          padding: 5
        });
